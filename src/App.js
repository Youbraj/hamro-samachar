      ...
      <div>
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route exact path="/technology" element={<News setProgress={setProgress} apiKey={apiKey} key="technology" pageSize={6} country="us" category="technolgoy"/>} />
                ...
                {/* <News  apiKey={apiKey} pageSize={6} country="us" category="science"/> */}
            </Routes>
        </BrowserRouter>
      </div>
    )
